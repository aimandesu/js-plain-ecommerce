function createForm() {
  ...
  my_email.value = document.getElementById("input-email");

  my_name = document.createElement("input");
  my_name.type = "text";
  my_name.name = "my-name";
  my_name.value = document.getElementById("input-name");

  my_location = document.createElement("input");
  my_location.type = "text";
  my_location.name = "my-location";
  my_location.value = document.getElementById("input-location");

  my_order = document.createElement("input");
  my_order.type = "text";
  my_order.name = "my-order";
  my_order.value = document.getElementById("input-order");
